...
export default function GroceryCard({title,image}) {
  ...
  return (
    <Link to={`/grocerydetail/${title}`} className={`block m-1 text-center rounded-2xl w-[full] h-[200px] sm:w-[340px] sm:h-[410px] sm:p-1 ${isDark?"shadow-sm shadow-white":"shadow-lg"}`}>
