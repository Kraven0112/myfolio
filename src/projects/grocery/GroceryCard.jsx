...
export default function GroceryCard({title,image}) {
  ...
  return (
    <Link to={`/grocerydetail/${title}`} className={`block m-2 text-center rounded-2xl w-[full] h-[200px] sm:w-[340px] sm:h-[410px] sm:m-0 sm:p-1 ${isDark?"shadow-sm shadow-white":"shadow-lg"}`}>
