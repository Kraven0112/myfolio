...
export default function CountryCard({title,image,capital,continent,region}) {
  ...
  return (
    <Link to={`/country/${title}`} className={`block overflow-hidden rounded-xl md:rounded-2xl sm:w-[300px] md:w-[340px] md:h-[415px] hover:scale-[1] my-2 ${isDark?"shadow-sm shadow-white":"shadow-lg"}`}>
