    ...
    return (
        <main className={`min-h-[89.5vh] p-4 ${isDark
            ...
            <div className="max-w-[1000px] mx-auto mt-1">
                <h1 className={`text-xl sm:text-2xl md:text-4xl font-bold underlin{`}>Html</h1>
      ${isDark?"text-green-200":""}`}          <p className={`text-pretty sm:text-xl`}>HTML is strtuctural language used to create structure of website. It is used to create and structure content on the web. It defines the layout and elements of web pages, allowing browsers to display text, images, and other multimedia.</p>
            </div>

            <div className="max-w-[1000px] mx-auto mt-5">
                <h1 className={`text-xl sm:text-2xl md:text-4xl font-bold underline{`}>CSS</h1>
       ${isDark?"text-green-200":""}`}         <p className={`text-pretty sm:text-xl`}>CSS stands for cascading style sheet. It is used to decorate the webpages like font,colors, layout. It allows developers to separate content from design, making it easier to maintain and style websites across different devices.</p>
            </div>
            <div className="max-w-[1000px] mx-auto mt-5">
